# Contributing to Katalon Analytics

Welcome, and thank you for your interest in contributing to Katalon Analytics!
...
Before you create a new issue, please do a search in [open issues](https://github.com/katalon-analytics/katalon-analytics/issues) to see if the issue or feature request has already been filed.

Be sure to scan through the [most popular](https://github.com/katalon-analytics/katalon-analytics/issues?q=is%3Aopen+is%3Aissue+label%3Afeature-request+sort%3Areactions-%2B1-desc) feature requests.
...
* Version of Katalon Studio, Browser Version
...
* [ ] Simplify your step around the issue to better isolate the problem
...
Your contributions to us make great projects like this possible. Thank you for taking the time to contribute.
